...
Name "test Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_test_${VERSION}.exe"
...
; Sections
Section "test" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\test"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\test\Plugin_test.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\test\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\test"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\test\Plugin_test.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\test\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_test"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_test\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "test Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the test Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "test Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_test\changelog.md"'
FunctionEnd
